...
1. you will find a executable jar “parser”.
2. You could run -
java -cp "parser.jar" com.ef.Parser --accesslog=/path/to/file --startDate=2017-01-01.13:00:00 --duration=hourly -- threshold=100
3. For Example:
java -cp "parser.jar" com.ef.Parser C:/Users/kgopu/Desktop/test/access.log 2017-01-01.00:00:00 daily 500
4. Then it asks if you want to store the data to DataBase. If you press ‘Y’, You will be asked for the MYSQL URL. Enter - jdbc:mysql://localhost:3306. Hoping MYSQL is installed on your local machine.
5. Then it asks for ‘username’ and ‘password’. Enter them. Program will create the database for you and store the records. You need not create the Schema.
